...
# install the latest version of phpMyAdmin on Vagrant (see https://github.com/grrnikos/pma/blob/master/pma.sh)
# From https://stackoverflow.com/a/59825964/5155484
# in case of errors see https://github.com/laravel/homestead/issues/1439
